...
The dossier contains a Spanish item name (e.g., "tuberia", "cuchillo"). You MUST use the MCP tool to translate it.
...
Example: If the dossier says "Item noted (Spanish): tuberia", call:
```
Server: mansion-translator
Tool: translate
Arguments: { "word": "tuberia" }
```
