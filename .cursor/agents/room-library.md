...
The dossier contains a Spanish item name (e.g., "cuchillo", "cuerda"). You MUST use the MCP tool to translate it.
...
Example: If the dossier says "Item noted (Spanish): cuchillo", call:
```
Server: mansion-translator
Tool: translate
Arguments: { "word": "cuchillo" }
```
